...
/*
When a method returns multiple values, you can retrieve them from the args object using the corresponding index:
...
args.Get(0) will give you the *domain.Specification.
args.Error(1) will give you the error.
And if you have more return values, you can continue in the same pattern:

args.Get(1) will give you the second return value.
args.Get(2) will give you the third return value, and so on.
*/
