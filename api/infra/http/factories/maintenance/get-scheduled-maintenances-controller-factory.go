...
func GetScheduledMaintenancesFactoryController(context *gin.Context) {
	...
	getScheduledMaintenancesUseCase := usecases.NewGetScheduledMaintenancesUseCase(maintenanceRepository)

	maintenanceendpoints.GetScheduledMaintenancesController(context, getScheduledMaintenancesUseCase)
